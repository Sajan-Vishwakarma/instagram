...
import com.instagram.exception.MediaException;
...
public class ExceptionControllerAdvice {
    ...
    public ResponseEntity<ErrorInfo> followExceptionHandler(LikesException exception) {
    ...
    public ResponseEntity<ErrorInfo> followExceptionHandler(PostsException exception) {
        LOGGER.error(exception.getMessage(), exception);
        ErrorInfo errorInfo = new ErrorInfo();
        errorInfo.setErrorCode(HttpStatus.BAD_REQUEST.value());
        errorInfo.setErrorMessage(environment.getProperty(exception.getMessage()));
    ...
    public ResponseEntity<ErrorInfo> followExceptionHandler(MediaException exception) {
        LOGGER.error(exception.getMessage(), exception);
        ErrorInfo errorInfo = new ErrorInfo();
        errorInfo.setErrorCode(HttpStatus.BAD_REQUEST.value());
        errorInfo.setErrorMessage(environment.getProperty(exception.getMessage()));
    ...
    public ResponseEntity<ErrorInfo> followExceptionHandler(CommentsException exception) {
        LOGGER.error(exception.getMessage(), exception);
        ErrorInfo errorInfo = new ErrorInfo();
        errorInfo.setErrorCode(HttpStatus.BAD_REQUEST.value());
        errorInfo.setErrorMessage(environment.getProperty(exception.getMessage()));
